...
1. Wejdź na [Google Search Console](https://search.google.com/search-console) i zaloguj się kontem Google
...
- **Linia płaska od pół roku** to niemal zawsze zły znak przy aktywnej pracy SEO. Coś się powinno ruszać, choćby powoli
...
Jedna pułapka: odfiltruj zapytania z nazwą Twojej firmy. Ludzie, którzy wpisują w Google "Kowalski instalacje Radom", i tak by Cię znaleźli, agencja nie ma tu żadnej zasługi. W zakładce Skuteczność kliknij **+ Nowy** → **Zapytanie** → **Niezawierające zapytania** i wpisz nazwę firmy. To, co zostanie, to ruch, za który realnie płacisz.
...
2. **Historia zmian na stronie:** wejdź na [web.archive.org](https://web.archive.org) (Wayback Machine), wpisz adres swojej strony i porównaj wersję sprzed pół roku z obecną. Zobaczysz czarno na białym, czy treść się zmieniła
...
4. **Szybkość strony:** wklej adres w [PageSpeed Insights](https://pagespeed.web.dev), darmowe narzędzie Google. Wynik poniżej 50 na urządzeniach mobilnych to problem, o którym agencja powinna była Ci powiedzieć
...
| Odpowiedź dobrej agencji | Odpowiedź złej agencji |
|---|---|
...
*Masz wątpliwości co do swojej agencji SEO? Napisz do mnie na [LinkedIn](https://www.linkedin.com/in/michal-danieluk/). Chętnie zerknę i powiem, co widzę.*
